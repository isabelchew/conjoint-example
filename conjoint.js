...
// Create Variables for Traits associated with each dimension.
	if (Math.random() <0.33) {
		var vname = ["Sai Maung Maung", "Aung Kyang Ko"];
	} else if (Math.random()<0.66) {
		var vname = ["Aung Kyang Ko", "Lahpai Zau Let"];
	} else {
		var vname =["Lahpai Zau Let", "Sai Maung Maung"];
	}
var vhometown = ["Hlegu township, Yangon region", "Waingmaw township, Kachin state"];
var vreligion = ["Buddhist", "Christian"];
var vjob = ["Farmer", "Street vendor"];
var veducation = ["Completed primary education", "Some high school education"];

//Create function for setting restrictions on language spoken 
...
var traits_a = [vname[0],
			...
			vreligion[Math.floor(Math.random()*vreligion.length)],
			vjob[Math.floor(Math.random()*vjob.length)],
			   veducation[Math.floor(Math.random()*veducation.length)]];  	
...
function getlanguageA ( ) {
	if (traits_a[0] =="Sai Maung Maung" && traits_a[1] =="Hlegu township, Yangon region") {
		...
		var vlanguagespokenA  = vBurmeselanguagesKC[0];
	} else if (traits_a[0]=="Aung Kyang Ko" && traits_a[1] =="Waingmaw township, Kachin state") {
		var vlanguagespokenA  = vBurmeselanguagesKC[Math.floor(Math.random()*vBurmeselanguagesKC.length)];
...
function getlanguageB ( ) {	
		...
		var vlanguagespokenB  =  vBurmeselanguagesKC[0];
	} else if (traits_b[0]=="Aung Kyang Ko" && traits_b[1] =="Waingmaw township, Kachin state") {
		var vlanguagespokenB  = vBurmeselanguagesKC[Math.floor(Math.random()*vBurmeselanguagesKC.length)];
